              ...
              <div v-if="status === 'connected'">
                ...
                <form @submit.prevent="sendMessage" action="/">
                  <input v-model="message" class="form-control" placeholder="DNS Name..." @input="typing = true">
                    ...
                    <tbody>
                       <tr v-for="log in this.records.A" v-bind:key="log">
                        <td >
                            <a>A</a>
                        </td>
                        <td >
                       ...
                       <tr v-for="log in records.AAAA" v-bind:key="log">
                        <td >
                            <a>AAAA</a>
                        </td>
                        <td >
                       ...
                       <tr v-for="log in records.MX" v-bind:key="log">
                        <td >
                            <a>MX</a>
                        </td>
                        <td >
                       ...
                       <tr v-for="log in records.NS" v-bind:key="log">
                        <td >
                            <a>NS</a>
                        </td>
                        <td >
